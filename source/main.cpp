...
int main()
{
	// do we really need this gfxInit here? don't know
	...
	printf("with memchunkhax(1/2) via gpu by aliaspider\n\n\n");
	printf("(A) update\n(Y) downgrade\n(B) exit\n\n");
	printf("If you can install CIAs, don't use this.\n");
	printf("If you started the update you can't abort it!\n\n");
	printf("! Success ONLY when you see \"Updates installed.\".\n\n");
